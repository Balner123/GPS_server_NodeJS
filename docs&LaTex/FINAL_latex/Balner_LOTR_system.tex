...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%		
	...
	1. popisuje samotné zařízení, jeho návrh a kontrukci i příkladné použití
	2. popisuje kód serveru, jeho návrh, API a většinu možností uživatelského rozhraní

	3. pak již postup vývoje aplikace a její architekturu, avšak jak zmíněno výše, musí to být bráno jako jen jako analýza vzniklá reverzním inženýrstvím, ne přímou tvorbou.

...
Aplikace pro~Android je brána jako aplikace testovací (hlavně pro~testování API), ale zárověň ji lze použít jako plnohodnotného klienta pro~sběr a~odesílání GPS dat na~server.
Je však skutečností, že kód byl vytvořen pomocí LLM tudíž neručíme za~její kvalitu a~bezpečnost.
Byla sice zamýšlena jako plnohodnotná součást projektu, ale kvůli prioritám na~Server a~HW části ( rozprostření zájmů by bylo veliké) byla odsunutá a~její vývoj nechán na~LLM "Agentu".

...
Aplikace pro Android je brána jko aplikace testovací (hlavně pro testování API), ale zárověň ji lze použít jako plnohodnotného klienta pro sběr a odesílání GPS dat na server.
Je však skutečností, že kód byl vytvořen pomocí LLM tudíž neručíme za jeho kvalitu a bezpečnost.
...
\noindent Proto také dokumentace nezmiňuje detaily implementace, a omezuje se pouze na ukázku uživatelského rozhraní a jeho mžností.

...
Pro zabezpečení přístupu a možností third-party-autentizace je implementován mechanismus využívající knihovnu \texttt{passport.js}. Kromě lokálního přihlášení (email/heslo) je tak podporován i standard \textbf{OAuth 2.0} pro přihlášení přes externí poskytovatele (v našem případě: Google, GitHub).
...
\begin{itemize}
  ...
  \setlength\parsep{0pt}
    ...
    \item \texttt{Alert}: Záznamy o bezpečnostních událostech (např. opuštění geofence zóny nebo nárvat do ní).
\end{itemize}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{../docs_server/screenshots/swagger_docs.png} 
...
\subsubsection{ROOT účet} Z provozních důvodů systém startuje s hardcoded administrátorským účtem \texttt{ROOT}. Tento účet má vlástní administraci, která umožnuje přímí přístup do DB a manipulaci s jejími daty.
...
Frontendová část aplikace je dělaná s myšlenko ujednoduchosti. Kombinuje "server-side rendering" (EJS) pro základní strukturu stránky a klientský JavaScript pro dynamické aktualizace dat v reálném čase.
...
Aby uživatel viděl aktuální polohu zařízení bez nutnosti obnovovat celou stránku, využívá aplikace technologii \textbf{AJAX} (Asynchronous JavaScript and XML) prostřednictvím moderního Fetch.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{../docs_server/schemas/Use_case_diagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{../docs_server/schemas/sequence_diagram_tracking.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{../docs_server/schemas/sequence_dia_registration_hw.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{../docs_server/schemas/sequence_dia_registration_apk.png}

...
Srdcem celého zařízení je vývojová deska \textbf{LilyGO T-Call} (verze V1.5), která v sobě integruje výkonný mikrokontrolér ESP32 a komunikační modem. Tato volba byla učiněna kvůli následujících kritérií:
\begin{itemize}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Baterie a nabíjecí/step-up modul – dva pohledy}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1.1\linewidth]{../docs_hw/schemas/life_cycle_sequence_dia.png} 

...
- LTE: připojte primární anténu do konektoru „MAIN“. Doporučuje se přidat i AUX pro diverzitu.
- GPS: připojte aktivní GPS anténu do konektoru označeného „GPS".

## Referenční materiály

- Schémata a výkresy: `docs_hw/schemas/` (PDF/obrázky).
- Přehled signálů: `docs_hw/schemas/ZAPOJENI.txt`.

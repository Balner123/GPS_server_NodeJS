...
- Výchozí OTA heslo je pouze pro první konfiguraci; doporučuje se ho změnit po prvním připojení.
- Ujistěte se, že komunikace na server probíhá výhradně přes HTTPS a že jsou ověřeny certifikáty.
